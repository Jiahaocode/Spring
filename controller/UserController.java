...
import com.ithima.reggie.utils.MailUtils;
...
public class UserController {
    ...
    @PostMapping("/sendMsg")
    public R<String> sendMsg(@RequestBody User user, HttpSession session) throws MessagingException, MessagingException, MessagingException {
